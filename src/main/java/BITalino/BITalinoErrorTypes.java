...
/**
 * Enumeration containing all possible error types generated by BITalino operations.
 * Each error type is associated with an integer value and a descriptive name.
 *
 * These errors represent communication failures, invalid parameters,
 * and incorrect device usage states. They are used by {@link BITalinoException}
 * to provide detailed error reporting.
 */
public enum BITalinoErrorTypes {
    ...
    /**
     * Constructs a BITalino error type with a numeric code and description.
     *
     * @param value numerical value associated with the error
     * @param name textual description of the error
     */
    ...
    /**
     * @return the numerical value of this error type
     */
    public int getValue()
    {
        return value;
    ...
    /**
     * @return the descriptive name of this error type
     */
